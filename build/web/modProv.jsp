...
<fieldset id="newsletter">
    <form method="post" action="modificaProveedor" name="modprov">
        ...
        <input name="email" class="btmspace-15" type="text" value="<%=objConn.rs.getString(6)%>" placeholder="RFC" onchange="noVacio(this)">
        <section class="one_half first">
            <input name="calle" class="btmspace-15" type="text" value="<%=objConn.rs.getString(7)%>" placeholder="Calle" onchange="noVacio(this)">
        </section>  
        <section class="one_half">
            <input name="numero" class="btmspace-15" type="text" value="<%=objConn.rs.getString(8)%>" placeholder="Numero" onchange="soloNumeros(this)">
        </section>
        <input name="colonia" class="btmspace-15" type="text" value="<%=objConn.rs.getString(9)%>" placeholder="Colonia" onchange="noVacio(this)">
        <input name="ciudad" class="btmspace-15" type="text" value="<%=objConn.rs.getString(10)%>" placeholder="Ciudad" onchange="noVacio(this)">
        <input name="estado" class="btmspace-15" type="text" value="<%=objConn.rs.getString(11)%>" placeholder="Estado" onchange="noVacio(this)">
        <section class="one_half first">
            <input name="pais" class="btmspace-15" type="text" value="<%=objConn.rs.getString(12)%>" placeholder="País" onchange="noVacio(this)">
        </section>
        <section class="one_half">
            <input name="cp" class="btmspace-15" type="text" value="<%=objConn.rs.getString(13)%>" placeholder="Código Postal" onchange="soloNumeros(this)">
        </section>
        <br><br><br>
