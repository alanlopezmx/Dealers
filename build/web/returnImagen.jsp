<%-- 
    Document   : returnPromo
    Created on : 21-nov-2016, 12:20:26
...
<%
    int img_id = Integer.parseInt(request.getParameter("idImagen"));
    PreparedStatement pstmt = null;
    OutputStream oImage;
    try {
    pstmt = objConn.prepareStatement("select imagen from imagen where idImagen=?;");
