 ...
 */
@WebServlet("/insertProveedor")
public class InsertProveedor extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request,
        ...
        if (n > 0) { // ya existe ese usuario
            ...
            consulta = "insert into proveedor (nombre,ap_paterno,ap_materno,telefono,rfc,calle,numero,colonia,ciudad,estado,pais,cp) values("
                    + "'" + nombre + "','" + appat + "','" + apmat + "','" + telefono + "','" + rfc + "','"
                    + calle + "','" + numero + "','" + colonia + "','" + ciudad + "','" + estado + "','" + pais + "','" + cp + "');";
